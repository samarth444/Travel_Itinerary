...
public class FlightBookingController {
    ...
    public String bookFlight(@PathVariable("flightId") Long flightId,
        ...
        // Decrease available seats when booking the flight
        int remainingSeats = flight.getSeatsAvailable() - booking.getNumberOfPassengers();
        if (remainingSeats < 0) {
            throw new IllegalStateException("Not enough seats available for this flight.");
        }

        // Update seats_available in the flight object
        flight.setSeatsAvailable(remainingSeats);
